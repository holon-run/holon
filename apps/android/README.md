...
The debug app defaults to `http://10.0.2.2:7878/api` for an Android emulator
connecting to a daemon on the development host. Only the debug build permits
cleartext traffic to `10.0.2.2`. Its session credential field accepts an
already-exchanged session credential and stores it using Android Keystore;
