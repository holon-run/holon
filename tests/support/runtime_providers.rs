...
use super::runtime_helpers::{
    compact_request_snapshot, delegated_prompt_text, preserves_prior_tool_context,
};

// Import the compaction snapshot type from runtime_helpers
use super::runtime_helpers::CompactionRequestSnapshot;
