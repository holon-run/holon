...
pub fn config_schema() -> Vec<ConfigSchemaEntry> {
    vec![
        ...
        ConfigSchemaEntry {
            ...
            kind: "enum",
            description: "Legacy shortcut for providers.<id>.endpoints.default.transport.",
            default: Value::Null,
            allowed_values: vec![
        ...
        ConfigSchemaEntry {
            ...
            kind: "string",
            description: "Legacy shortcut for providers.<id>.endpoints.default.base_url.",
            default: Value::Null,
            allowed_values: vec![],
        },
        ConfigSchemaEntry {
            key: "providers.<id>.endpoints.<endpoint_id>.transport",
            kind: "enum",
            description: "Model provider transport for a named endpoint. The default endpoint is also addressable through providers.<id>.transport.",
            default: Value::Null,
            allowed_values: vec![
                "openai_codex_responses",
                "openai_responses",
        ...
        ConfigSchemaEntry {
            key: "providers.<id>.endpoints.<endpoint_id>.base_url",
            kind: "string",
            description: "Model provider API base URL for a named endpoint. The default endpoint is also addressable through providers.<id>.base_url.",
            default: Value::Null,
            allowed_values: vec![],
        },
        ConfigSchemaEntry {
            key: "providers.<id>.endpoints.<endpoint_id>.auth.source",
            kind: "enum",
            description: "Credential source for a named provider endpoint.",
            default: Value::Null,
            allowed_values: vec![
                "env",
                "external_cli",
        ...
        ConfigSchemaEntry {
            key: "providers.<id>.endpoints.<endpoint_id>.auth.kind",
            kind: "enum",
            description: "Credential material kind for a named provider endpoint.",
            default: Value::Null,
            allowed_values: vec![
                "api_key",
                "bearer_token",
        ...
        ConfigSchemaEntry {
            key: "providers.<id>.endpoints.<endpoint_id>.auth.env",
            kind: "string",
            description: "Environment variable name used when endpoint auth.source=env.",
            default: Value::Null,
            allowed_values: vec![],
        },
        ConfigSchemaEntry {
            key: "providers.<id>.endpoints.<endpoint_id>.auth.profile",
            kind: "string",
            description: "Credential profile id used when endpoint auth.source=credential_profile.",
            default: Value::Null,
            allowed_values: vec![],
        },
        ConfigSchemaEntry {
            key: "providers.<id>.endpoints.<endpoint_id>.auth.external",
            kind: "string",
            description: "External credential provider id used when endpoint auth.source=external_cli.",
            default: Value::Null,
            allowed_values: vec![],
        },
        ConfigSchemaEntry {
            key: "providers.<id>.plans.<plan_id>.endpoint",
            kind: "provider_endpoint_ref",
            description: "Named provider plan endpoint route. This is persisted routing metadata; legacy provider/model refs remain supported.",
            default: Value::Null,
            allowed_values: vec![],
        },
        ConfigSchemaEntry {
