//! Built-in provider/model registry data and defaults.
...
use super::file::{ClaudeSettings, HolonConfigFile};
use super::get_config_value;
use super::normalize_credential_profile_id;
use super::providers::{
    AnthropicContextManagementConfig, CredentialKind, CredentialSource, CredentialStoreFile,
    ProviderAuthConfig, ProviderAuthView, ProviderBuiltinWebSearchConfig, ProviderConfigFile,
    ProviderConfigView, ProviderId, ProviderRegistry, ProviderRuntimeConfig, ProviderTransportKind,
    OPENAI_CODEX_CREDENTIAL_PROFILE,
};
use super::resolve_anthropic_compatible_context_management_config;
use super::resolve_anthropic_context_management_config;
use super::AppConfig;
...
pub fn built_in_provider_default_config_with_settings(
    provider_id: &ProviderId,
...
pub fn built_in_provider_registry_with_settings(
    settings_env: &HashMap<String, String>,
) -> Result<ProviderRegistry> {
...
pub fn insert_openai_compatible_provider(
...
pub fn insert_anthropic_compatible_provider(
    registry: &mut ProviderRegistry,
    provider: &str,
    default_base_url: &str,
    env_names: &[&str],
...
pub fn insert_vercel_ai_gateway_provider(
    registry: &mut ProviderRegistry,
    settings_env: &HashMap<String, String>,
) -> Result<()> {
...
pub fn insert_builtin_http_provider(
    registry: &mut ProviderRegistry,
    provider: &str,
...
pub fn insert_builtin_http_provider_with_context_management(
    registry: &mut ProviderRegistry,
    provider: &str,
    transport: ProviderTransportKind,
    default_base_url: &str,
...
pub fn openai_builtin_web_search_config() -> ProviderBuiltinWebSearchConfig {
...
pub fn openai_codex_builtin_web_search_config() -> ProviderBuiltinWebSearchConfig {
    ProviderBuiltinWebSearchConfig {
        enabled: true,
        kind: ProviderNativeWebSearchKind::OpenAi,
...
pub fn anthropic_builtin_web_search_config() -> ProviderBuiltinWebSearchConfig {
    ProviderBuiltinWebSearchConfig {
        enabled: true,
...
pub fn zai_builtin_web_search_config() -> ProviderBuiltinWebSearchConfig {
    ProviderBuiltinWebSearchConfig {
        enabled: true,
        kind: ProviderNativeWebSearchKind::Anthropic,
        advertised_tool_type: "web_search_20250305".to_string(),
...
pub fn bigmodel_builtin_web_search_config() -> ProviderBuiltinWebSearchConfig {
    ProviderBuiltinWebSearchConfig {
        enabled: true,
        kind: ProviderNativeWebSearchKind::Anthropic,
        advertised_tool_type: "web_search_20250305".to_string(),
...
pub fn deepseek_builtin_web_search_config() -> ProviderBuiltinWebSearchConfig {
    ProviderBuiltinWebSearchConfig {
        enabled: true,
        kind: ProviderNativeWebSearchKind::Anthropic,
        advertised_tool_type: "web_search_20250305".to_string(),
...
pub fn env_key_fragment(provider: &str) -> String {
    provider
        .chars()
        .map(|ch| {
...
pub fn resolve_first_env_value(
    env_names: &[&str],
    settings_env: &HashMap<String, String>,
...
pub fn validate_openai_reasoning_effort(value: &str) -> Result<()> {
    match value {
...
pub fn validate_provider_builtin_web_search(
    provider_id: &ProviderId,
    provider_config: &ProviderConfigFile,
) -> Result<()> {
...
pub fn validate_provider_auth(provider_id: &ProviderId, auth: &ProviderAuthConfig) -> Result<()> {
