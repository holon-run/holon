//! Credential store, profile, and resolution helpers.
...
use super::file::HolonConfigFile;
use super::providers::{CredentialKind, CredentialSource};
use super::providers::{CredentialProfileFile, CredentialProfileStatus, CredentialStoreFile};
...
pub fn normalize_credential_profile_id(profile: &str) -> Result<String> {
...
pub fn validate_stored_credential_kind(kind: CredentialKind) -> Result<()> {
    match kind {
...
pub fn config_uses_credential_profiles(config: &HolonConfigFile) -> bool {
    config
        .providers
        .values()
