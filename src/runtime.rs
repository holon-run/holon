...
use crate::{
    ...
    provider::{
        build_provider_from_model_chain, provider_attempt_timeline, AgentProvider, ModelBlock,
    },
    queue::RuntimeQueue,
...
impl RuntimeHandle {
    ...
    fn new_internal(
        ...
        let initial_workspace_entry = match &initial_workspace {
            ...
            InitialWorkspaceBinding::Anchor(anchor) => Some(WorkspaceEntry::new(
