//! Turn execution: the core agent loop and round-level tool execution.
//!
//! This module owns the large `TurnExecution::run` method that drives the
//! provider loop, tool dispatch, context compaction, and checkpoint logic.
