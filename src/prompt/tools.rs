...
mod tests {
    ...
    fn test_exec_command_batch_section_emitted_when_available() {
        ...
        assert!(section.content.contains("does not promote timed-out items"));
