...
mod tests {
    ...
    fn test_exec_command_batch_section_emitted_when_available() {
        ...
        assert!(section
            .content
            .contains("WaitFor(wake=task_result, resource=<task_id>)"));
