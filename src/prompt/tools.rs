...
mod tests {
    ...
    fn test_work_item_write_section_emitted_when_available() {
        ...
        assert!(section.content.contains("not as a current-turn checklist"));
