...
pub(super) struct TuiApp {
    ...
    pub(super) event_history_load_in_flight: bool,
    pub(super) message_hydration_in_flight: Option<String>,
    pub(super) brief_hydration_in_flight: Option<String>,
    pub(super) snapshot_refresh_request_id: u64,
    pub(super) stream_connect_request_id: u64,
    pub(super) event_history_request_id: u64,
    pub(super) agent_list_refresh_failures: u32,
...
impl TuiApp {
    pub(crate) fn new(client: LocalClient, log_writer: TuiLogWriter) -> Self {
        ...
        Self {
            ...
            event_history_load_in_flight: false,
            message_hydration_in_flight: None,
            brief_hydration_in_flight: None,
            snapshot_refresh_request_id: 0,
            stream_connect_request_id: 0,
            event_history_request_id: 0,
            agent_list_refresh_failures: 0,
            reconnect_attempt: 0,
            selected_agent: 0,
            preferred_agent_id,
            state_path,
            ...
            overlay_shortcut_pending: false,
            slash_menu_selected: 0,
            slash_menu_dismissed_for: None,
            onboarding_model_picker: false,
