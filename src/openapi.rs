...
const ROUTES: &[RouteSpec] = &[
    ...
    route("get", "/templates/catalog", "templatesCatalog", "templates", "Template catalog", "Return the global AgentTemplate catalog (builtin + user global library + synced remote sources).", None, AuthKind::RemoteAccess),
