...
const ROUTES: &[RouteSpec] = &[
    ...
    route("post", "/api/skills/catalog/update", "updateSkillCatalog", "skills", "Update skill library (compatibility alias)", "Compatibility alias for reconciling local Skill Library contents with .skill-lock.json. This does not fetch remote updates.", Some("UpdateSkillRequest"), AuthKind::Control),
