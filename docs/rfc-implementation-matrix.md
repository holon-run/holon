...
| `rfc-tool-result-envelope` | [tool-result-envelope](rfcs/tool-result-envelope.md) | Implemented | shared tool result envelope | `cargo test` | Keep model-visible receipts bounded and canonical results structured. | 021 |
