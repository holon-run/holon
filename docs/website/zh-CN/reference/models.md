---
title: 支持的模型
description: Holon 内置支持的所有模型和提供商的完整参考。
generated: auto-generated from holon source — do not edit directly
summary: Holon 内置支持的所有模型和提供商的完整参考。
---

> **本页正文由源码自动生成，因此不单独翻译。** 它由 `cargo run --bin holon-docgen -- models` 从 Holon 源码生成，并随英文版一起更新。
> 英文原文：[Supported Models](/reference/models.md)
