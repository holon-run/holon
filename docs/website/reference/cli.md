---
title: CLI reference
summary: Holon's command-line interface — verified against holon --help (v0.29.0).
order: 10
---
<!-- maintenance: regenerate from `holon --help` output when commands change. Last regenerated against v0.29.0. -->
