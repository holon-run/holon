...
// ReviewReplies represents per-thread replies to review comments.
// This file is generated by the agent at /holon/output/review-replies.json
...
// ReviewReply represents a single reply to a review comment thread.
type ReviewReply struct {
	CommentID int64  `json:"comment_id"` // The comment_id from the review thread
	Status    string `json:"status"`     // fixed|wontfix|need-info
	Message   string `json:"message"`    // Human-readable reply message
}
