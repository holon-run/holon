...
func DefaultBuiltinAgent() *BuiltinAgent {
	return &BuiltinAgent{
		Name:     "claude-agent",
		Version:  "agent-claude-v0.9.0",
		URL:      "https://github.com/holon-run/holon/releases/download/agent-claude-v0.9.0/holon-agent-claude-0.9.0.tar.gz",
		Checksum: "6d5c5c750d7f0d9d9d7070bb4735ce6e4770c5d2d49f0567bc58ee52525d4425",
	}
}
