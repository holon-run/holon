...
func BuildInstallScript() string {
	...
	b.WriteString("  if [ \"$MAJOR\" -ge 20 ] && command -v npm >/dev/null 2>&1; then return; fi\n")
	b.WriteString("  case \"$PM\" in\n")
	b.WriteString("    apt)\n")
	...
	b.WriteString("      echo \"deb [signed-by=/etc/apt/keyrings/nodesource.gpg] https://deb.nodesource.com/node_20.x nodistro main\" > /etc/apt/sources.list.d/nodesource.list\n")
	b.WriteString("      retry_cmd apt-get update -o Acquire::Retries=3\n")
	...
	b.WriteString("      ;;\n")
	b.WriteString("    dnf)\n")
	b.WriteString("      curl -fsSL https://rpm.nodesource.com/setup_20.x | bash -\n")
